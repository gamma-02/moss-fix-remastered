...
public class FeatureMixin {
    ...
    @WrapOperation(
            ...
            at = @At(
                    value = "INVOKE",
                    target = "Lnet/minecraft/world/level/levelgen/feature/Feature;register(Ljava/lang/String;Lnet/minecraft/world/level/levelgen/feature/Feature;)Lnet/minecraft/world/level/levelgen/feature/Feature;",
                    ordinal = #if MC_VERSION < 12105 19 #else 20 #endif
            )
    )
